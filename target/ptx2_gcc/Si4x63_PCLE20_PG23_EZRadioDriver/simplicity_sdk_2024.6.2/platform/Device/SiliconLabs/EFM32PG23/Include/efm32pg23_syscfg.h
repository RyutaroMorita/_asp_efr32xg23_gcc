/**************************************************************************//**
 * @file
 * @brief EFM32PG23 SYSCFG register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFM32PG23_SYSCFG_H
#define EFM32PG23_SYSCFG_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFM32PG23_SYSCFG SYSCFG
 * @{
 * @brief EFM32PG23 SYSCFG Register Declaration.
 *****************************************************************************/
...
typedef struct syscfg_typedef{
  ...
  uint32_t       RESERVED8[66U];                /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED9[120U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED11[635U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED15[54U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED20[66U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED21[120U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED23[635U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED27[54U];               /**< Reserved for future use                            */
  uint32_t       RESERVED28[1U];                /**< Reserved for future use                            */
  uint32_t       RESERVED29[63U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED31[64U];               /**< Reserved for future use                            */
  __IOM uint32_t RAMBIASCONF_CLR;               /**< RAM Bias Configuration                             */
  uint32_t       RESERVED32[66U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED33[120U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED35[635U];              /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED44[66U];               /**< Reserved for future use                            */
  ...
  uint32_t       RESERVED45[120U];              /**< Reserved for future use                            */
...
/** @} End of group EFM32PG23_SYSCFG */

/**************************************************************************//**
 * @addtogroup EFM32PG23_SYSCFG
 * @{
 * @defgroup EFM32PG23_SYSCFG_BitFields SYSCFG Bit Fields
 * @{
 *****************************************************************************/
...
/** @} End of group EFM32PG23_SYSCFG_BitFields */
/** @} End of group EFM32PG23_SYSCFG */
/**************************************************************************//**
 * @defgroup EFM32PG23_SYSCFG_CFGNS SYSCFG_CFGNS
 * @{
 * @brief EFM32PG23 SYSCFG_CFGNS Register Declaration.
 *****************************************************************************/
...
/** @} End of group EFM32PG23_SYSCFG_CFGNS */

/**************************************************************************//**
 * @addtogroup EFM32PG23_SYSCFG_CFGNS
 * @{
 * @defgroup EFM32PG23_SYSCFG_CFGNS_BitFields SYSCFG_CFGNS Bit Fields
 * @{
 *****************************************************************************/
...
/** @} End of group EFM32PG23_SYSCFG_CFGNS_BitFields */
/** @} End of group EFM32PG23_SYSCFG_CFGNS */
/** @} End of group Parts */

#endif // EFM32PG23_SYSCFG_H
